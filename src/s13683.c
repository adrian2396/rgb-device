...
{
    int i2c_master_port = S13683_MASTER_NUM;
    i2c_config_t conf = {
        .mode = I2C_MODE_MASTER,
        .sda_io_num = S13683_SDA_IO,
        .sda_pullup_en = GPIO_PULLUP_ENABLE,
        .scl_io_num = S13683_SCL_IO,
        .scl_pullup_en = GPIO_PULLUP_ENABLE,
        .master.clk_speed = S13683_MASTER_FREQ_HZ,
    ...
    return i2c_driver_install(i2c_master_port, conf.mode, S13683_MASTER_TX_BUF_DISABLE, S13683_MASTER_RX_BUF_DISABLE, 0);
}
